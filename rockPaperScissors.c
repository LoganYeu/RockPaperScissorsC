...
// Prints the menu screen and gets the users choice. Returns number to decide what to do in the main method.
int mainMenu(void) {
    ...
    while (scanf("%d", &userInput)) {
        if (userInput == 1) {
            // Returns 1 for the if statement in main method to run the rock paper scissors game.
            printf("Beginning game...\n");
            return 1;
        }
        else if (userInput == 2) {
            // Returns two for the if statement found in main to load a save game.
...
/*
 * Method runs the rock paper scissors
...
// Method to clear the input stream in order to refresh the scanner.
